...
public:
    ...
    {
        /* DONE: your code is here for the initialization
         */
    ...
    int len()
    {
        /* DONE: your code is here to return the dataset's length
         */
        return data_shape[0];
    }
    ...
    DataLabel<DType, LType> getitem(int index)
    {
        ...
        auto data_item = xt::row(data, index);
        auto label_item = xt::row(label, index);
    ...
    {
        /* DONE: your code is here to return data_shape
         */
        return data_shape;
    }
    ...
    {
        /* DONE: your code is here to return label_shape
         */
        return label_shape;
    }
};
